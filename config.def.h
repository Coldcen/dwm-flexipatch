...
#else
static const char *fonts[]               = { "Symbols Nerd Font:size=18" };
...
static const char *ip[]  = { "/home/cen/Documents/bashs/ip.sh", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_w,      spawn,          {.v = wechat } },
	{ MODKEY,                       XK_n,      spawn,          {.v = pic } },
